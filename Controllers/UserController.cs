...
public class UserController
{
    ...
    public void RegisterUser(User user)
    {
        using (var db = new AppDbContext(credentials: Credentials))
        {
            ...
            {
                Console.WriteLine("Nombre de usuario ya exite");
            }
    ...
    public string EmptyInputValidator(string prompt)
    {
        while (true)
        {
            ...
            {
                Console.WriteLine("Valor requerido, intento de nuevo");
            }
        }
    }
    ...
    public int IntegerInputValidator(string prompt)
    {
        while (true)
        {
            ...
            {
                Console.WriteLine("El valor debe ser un numero");
            }
        }
    }
        ...
        string? Password)
    {
        using (var db = new AppDbContext(Credentials))
        {
            ...
            if (user != null)
            {
                ...
                db.SaveChanges();
                Console.WriteLine($"Usuario con {id} ha sido actualizado");
            }
            else
            {
                Console.WriteLine("Usuario no encontrado");
